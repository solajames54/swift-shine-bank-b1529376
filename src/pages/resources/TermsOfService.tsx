...
const sections = [
  { title: "1. Acceptance of Terms", content: "By accessing or using AlliantCred Union's services, you agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree to these terms, do not use our services. You must be at least 18 years old to open an account." },
  ...
  { title: "3. Banking Services", content: "AlliantCred Union provides digital banking services including checking and savings accounts, fund transfers, bill payments, and card management. All deposits are FDIC-insured up to $250,000 per depositor. Services are subject to applicable banking regulations." },
  ...
  { title: "6. Intellectual Property", content: "All content, software, and materials on AlliantCred Union are owned by us or our licensors. You may not copy, modify, distribute, or create derivative works without our written permission. Your account data remains your property." },
  { title: "7. Limitation of Liability", content: "AlliantCred Union is not liable for indirect, incidental, or consequential damages arising from your use of our services. Our total liability is limited to the fees you've paid in the 12 months preceding the claim. This does not limit liability for losses from unauthorized transactions where we are at fault." },
...
export default function TermsOfService() {
  return (
    <ResourceLayout title="Terms of Service" subtitle="Last updated: March 2026. Please read these terms carefully before using AlliantCred Union.">
