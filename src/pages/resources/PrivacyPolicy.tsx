...
const sections = [
  ...
  { title: "Your Rights", content: "You have the right to access, correct, or delete your personal data; opt out of marketing communications; request a copy of your data in a portable format; and lodge a complaint with a supervisory authority. To exercise these rights, contact privacy@vaultbank.com." },
