...
export default function OTPPage() {
  ...
  const { verify, generatedOtp, pendingUser, login, otpPending } = useAuthContext();
  ...
  useEffect(() => {
    ...
    if (generatedOtp) {
      toast.info(`Your OTP code: ${generatedOtp}`, { duration: 10000 });
    }
  }, [otpPending, navigate, generatedOtp]);
  ...
  const handleResend = () => {
    ...
    setCountdown(60);
    setDigits(["", "", "", "", "", ""]);
    toast.info(`New OTP code: ${generatedOtp}`, { duration: 10000 });
  };
