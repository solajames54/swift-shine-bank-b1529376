        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <ScrollReveal delay={240}>
              <div className="flex flex-wrap gap-3">
                ...
                <Button variant="hero-outline" size="xl" className="border-white/20 text-white hover:bg-white/10">
                  See How It Works
                </Button>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={320}>
              <div className="flex items-center gap-6 mt-10 pt-8 border-t border-white/10">
                <div>
                  ...
                  <p className="text-sm text-white/50">Transactions processed</p>
                </div>
                <div className="w-px h-10 bg-white/10" />
                <div>
                  <p className="text-2xl font-bold">99.99%</p>
                  <p className="text-sm text-white/50">Uptime guarantee</p>
                </div>
                <div className="w-px h-10 bg-white/10 hidden sm:block" />
                <div className="hidden sm:block">
                  <p className="text-2xl font-bold">150+</p>
                  <p className="text-sm text-white/50">Countries supported</p>
                </div>
              </div>
            </ScrollReveal>
          </div>
          ...
          <ScrollReveal delay={200} direction="right">
            <div className="relative">
              <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm shadow-2xl p-6 space-y-5">
              ...
              {/* Floating card */}
              <div className="absolute -bottom-4 -left-4 rounded-xl border border-white/10 bg-card text-card-foreground shadow-lg p-3 flex items-center gap-3 animate-fade-up stagger-5">
